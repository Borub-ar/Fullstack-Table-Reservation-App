...
const BookingTable = ({ number, capacity = '2–4 os.' }: BookingTableProps) => {
  return (
    <button className='group relative w-full aspect-square max-w-full rounded-xl sm:rounded-2xl bg-zinc-800/60 border border-zinc-700 flex flex-col items-center justify-center gap-1 sm:gap-2 hover:border-cyan-500/70 hover:bg-zinc-800 hover:shadow-lg hover:shadow-cyan-500/10 active:scale-[0.98] transition-all duration-200 touch-manipulation'>
